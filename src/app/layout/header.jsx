...
import LogoBlue from "media/logo/logo_blue.png"
import LogoMain from "media/logo/logo_main.png"
                ...
                <Row className="h-100">
                    <Col md={3} xs={6} sm={6} className="m-auto">
                        <div className={styles.headerLogo}>
                            <Link href="/"  >
                                {!scrolled ? (
                                    isLightHeader ? <Image src={LogoBlue} width={270} alt="logo" className="img-fluid"/> : <Image src={LogoMain} width={270} alt="logo" className="img-fluid"/>
                                ) : (
                                    <Image src={LogoBlue} alt="logo" width={220} className="img-fluid"/>
                                )}
                            </Link>
                        </div>
